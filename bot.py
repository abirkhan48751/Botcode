...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8869136136:AAGm4Zelplf0yV1qFjhRLuptDEiV3lb-_Lw")
...
def get_otp_keyboard():
    return InlineKeyboardMarkup([[InlineKeyboardButton("Get OTP", url="https://www.mailreader.online/")]])
...
async def send_home(update, context, text=None):
    ...
    await update.message.reply_text("Get OTP", reply_markup=get_otp_keyboard())
